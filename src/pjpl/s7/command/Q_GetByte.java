...
public class Q_GetByte extends Command{
	...
	public Q_GetByte(byte processId, Socket socket) throws IOException {
	...
	public CommandResponse action(pjpl.s7.process.Process process) {
		try {
			...
			Logger.getLogger(Q_GetByte.class.getName()).log(Level.SEVERE, null, ex);
		}
		return null;
	}
	...
	public short getCommandCode() {
		return (short)CommandCode.Q_GET_BYTE;
	}
